        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-12 md:gap-8 lg:gap-16">
          ...
          >
            ...
            <p className="font-sans text-[#555] text-sm leading-relaxed italic">
              Daughter of <br/>
              <span className="font-semibold text-[#2A2A2A] not-italic">Mr. Nawabpasha Sayed</span> <br/>
              & <br/>
              <span className="font-semibold text-[#2A2A2A] not-italic">Mrs. Haji Mastani Sayed</span>
            </p>
          </motion.div>
          ...
          >
            ...
            <h3 className="font-serif text-3xl text-[#800000] mb-2">Engg. Lucky Pathan</h3>
            <p className="font-sans text-[#D4AF37] text-sm uppercase tracking-widest font-semibold mb-4">
              B.Tech CSE <br/> Full Stack Developer
            </p>
            <p className="font-sans text-[#555] text-sm leading-relaxed italic">
              Son of <br/>
              <span className="font-semibold text-[#2A2A2A] not-italic">Dr. ShanNawabKhan S.S Pathan</span> <br/>
              & <br/>
              <span className="font-semibold text-[#2A2A2A] not-italic">Hasina Pathan</span>
            </p>
          </motion.div>
